...
window.MENU = [
  {
    id: "galletas",
    es: { name: "Galletas", note: "Horneadas del día · masa madre de mantequilla" },
    en: { name: "Cookies", note: "Baked fresh daily · buttery dough" },
    items: [
      { id: "g-chispas",  name: "Chispas de chocolate", en: "Chocolate Chip", star: true },
      { id: "g-kinder",   name: "Kinder Bueno",          en: "Kinder Bueno", star: true },
      { id: "g-ferrero",  name: "Ferrero",               en: "Ferrero" },
      { id: "g-redvelvet",name: "Red Velvet",            en: "Red Velvet" },
      { id: "g-pistache", name: "Pistache",              en: "Pistachio" },
      { id: "g-gloria",   name: "Gloria",                en: "Gloria" },
      { id: "g-oreo",     name: "Oreo",                  en: "Oreo" },
    ],
  },
  {
    id: "roles",
    es: { name: "Roles & Pan laminado", note: "Hojaldre lento de 24 horas" },
    en: { name: "Rolls & Laminated", note: "Slow 24-hour lamination" },
    items: [
      { id: "r-sticky",    name: "Rol Sticky",       en: "Sticky Roll", star: true },
      { id: "r-blueberry", name: "Rol de Blueberry", en: "Blueberry Roll" },
      { id: "r-canela",    name: "Rol de Canela",    en: "Cinnamon Roll", star: true },
      { id: "r-kinder",    name: "Rol de Kinder Bueno", en: "Kinder Bueno Roll" },
      { id: "r-pistache",  name: "Rol de Pistache",  en: "Pistachio Roll" },
      { id: "r-galleta",   name: "Rol de Galleta",   en: "Cookie Roll" },
    ],
  },
  {
    id: "postres",
    ...
    items: [
      { id: "p-tiramisu",   name: "Tiramisú",          en: "Tiramisu", star: true },
      { id: "p-dubai",      name: "Brownie Dubái",     en: "Dubai Brownie", star: true },
      { id: "p-vasco",      name: "Cheesecake Vasco",  en: "Basque Cheesecake" },
      { id: "p-concha",     name: "Concha de Vainilla",en: "Vanilla Concha" },
    ],
  },
];
...
window.I18N = {
  es: {
    ...
    hero: {
      ...
      title2: "hecha a mano",
      lead: "Galletas, pan laminado, roles y postres fríos horneados cada mañana con mantequilla de verdad y mucha paciencia. Coconos es tu panadería de barrio, elevada.",
      ctaPrimary: "Ver el menú",
      ctaGhost: "Vender Coconos",
      stats: [
        { n: "17+", l: "recetas de la casa" },
        { n: "24h", l: "de laminado lento" },
        { n: "100%", l: "mantequilla real" },
      ],
    ...
    about: {
      ...
      p1: "Coconos nació en una cocina pequeña, con la idea simple de hornear el tipo de pan que nos gustaría comer todos los días: mantequilloso, dorado y honesto.",
    ...
    footer: {
      ...
      made: "Hecho con mantequilla y cariño",
    },
  },
  en: {
    ...
    hero: {
      ...
      title1: "Fine pastry,",
      title2: "made by hand",
      lead: "Cookies, laminated pastry, rolls and cold desserts baked every morning with real butter and a lot of patience. Coconos is your neighborhood bakery, elevated.",
    ...
    about: {
      ...
      p1: "Coconos began in a small kitchen with a simple idea: to bake the kind of bread we'd want to eat every day — buttery, golden and honest.",
    ...
    footer: {
      ...
      made: "Made with butter and love",
    },
  },
};
